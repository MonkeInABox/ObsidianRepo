...
```
- Introduced ReLU activation and max pooling
# VGGNet
- 3x3 convolutions only
- Therefore high parameter count but better accuracy
- Deeper

# GoogLeNet
- Inception modules with parallel convolutions and pooling
- 1x1 convolutions used for dimensionality reduction, very efficient

# ResNet
- Solved vanishing gradient problem (gradients get too small) by adding residual connections that allow gradients to flow through network
